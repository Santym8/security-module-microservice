...
export class AuditService {
    ...
    async findAllByUser(userId: number, numberOfRecors: number): Promise<AuditResponse[]> {
        ...
        const audits = await this.auditRepository.getAllJoinUserAndFunctionByUser(userId, numberOfRecors);
